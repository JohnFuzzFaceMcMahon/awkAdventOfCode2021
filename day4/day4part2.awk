...
END {
    ...
    testTestTest=0; # what index was the number called
    yankYankYank=0; # final score
    boardBoardBoard=0;
    for (b=1;b<boardNumber+1;b++) {
        # print "### X board " b " bw " boardWon[b] " ttt " testTestTest " yyy " yankYankYank " bbb " boardBoardBoard " bf " boardFinal[b];
        if (boardWon[b]>testTestTest) {
            testTestTest=boardWon[b];
            yankYankYank=boardFinal[b];
            boardBoardBoard=b;
        }
        # print "### Y board " b " bw " boardWon[b] " ttt " testTestTest " yyy " yankYankYank " bbb " boardBoardBoard " bf " boardFinal[b];
    }
    print "### FINAL ANSWER IS BOARD " boardBoardBoard " AT CALL " testTestTest " WITH A SCORE OF " yankYankYank;
}